  ...
  return (
    <div className={styles.mainDiv}>
        ...
        <div>
            ...
            <div id="mc_embed_signup" className={styles.endDiv}>
                <form action="https://gmail.us1.list-manage.com/subscribe/post?u=25e4b92583f7fb818436b0d16&amp;id=ac91c13f3f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll" className={styles.form}>
                        <div class="mc-field-group" id={styles.mail2}>
                        ...
                        <div class="clear" id={styles.mail3}><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button" /></div>
                    </div>
                </form>
            </div>
            {/* <!--End mc_embed_signup--> */}
